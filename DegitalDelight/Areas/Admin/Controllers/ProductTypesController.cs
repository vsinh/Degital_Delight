...
namespace DegitalDelight.Areas.Admin.Controllers
{
    ...
    public class ProductTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Description")] ProductType productType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,IsDeleted")] ProductType productType)
        {
