...
!function (e, t) {
    ...
    function m(e, n, o) {
        ...
        return (d || !d && !o) && (("body" !== p(n) || h(v)) && (y = (i = n) !== t(i) && r(i) ? {
            ...
            r(n) ? ((b = f(n, !0)).x += n.clientLeft,
                b.y += n.clientTop) : v && (b.x = l(v))),
        {
    ...
    function te(e) {
        ...
        if (l) {
            var B = O(r)
                , H = "clientHeight"
                , T = "clientWidth";
            if (B === t(r) && "static" !== d(B = u(r)).position && "absolute" === c && (H = "scrollHeight",
                T = "scrollWidth"),
                B = B,
                i === j || (i === A || i === D) && a === k)
                M = E,
                    b -= (m && W.visualViewport ? W.visualViewport.height : B[H]) - o.height,
                    b *= p ? 1 : -1;
            if (i === A || (i === j || i === E) && a === k)
                P = D,
                    g -= (m && W.visualViewport ? W.visualViewport.width : B[T]) - o.width,
                    g *= p ? 1 : -1
        }
        ...
        fn: function (e) {
            ...
            Object.keys(t.elements).forEach((function (e) {
                var n = t.styles[e] || {}
                    , o = t.attributes[e] || {}
                    , i = t.elements[e];
                r(i) && p(i) && (Object.assign(i.style, n),
            ...
            return Object.assign(t.elements.popper.style, n.popper),
                ...
                function () {
                    Object.keys(t.elements).forEach((function (e) {
                        ...
                        r(o) && p(o) && (Object.assign(o.style, a),
    ...
    var le = {
        ...
        fn: function (e) {
            ...
            if (W) {
                ...
                if (c) {
                    var le, de = "x" === P ? j : A, he = "x" === P ? E : D, me = W[k], ve = "y" === k ? "height" : "width", ge = me + b[de], ye = me - b[he], be = -1 !== [j, A].indexOf(x), xe = null != (le = null == S ? void 0 : S[k]) ? le : 0, we = be ? ge : me - B[ve] - H[ve] - xe + R.altAxis, Oe = be ? me + B[ve] + H[ve] - xe - R.altAxis : ye, je = m && be ? function (e, t, n) {
                        var r = ue(e, t, n);
                        return r > n ? n : r
    ...
    var de = {
        ...
        phase: "main",
        fn: function (e) {
            var t, n = e.state, r = e.name, o = e.options, i = n.elements.arrow, a = n.modifiersData.popperOffsets, s = C(n.placement), f = F(s), c = [A, D].indexOf(s) >= 0 ? "height" : "width";
            if (i && a) {
                var p = function (e, t) {
